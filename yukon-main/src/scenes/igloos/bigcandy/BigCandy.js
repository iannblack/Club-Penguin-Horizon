...
export default class BigCandy extends IglooScene {
    ...
    _create() {
        ...
        // door
        const door = this.add.image(243, 478, "bigcandy", "door");
        ...
        // rectangle_1
        const rectangle_1 = this.add.rectangle(252, 561, 128, 128);
        rectangle_1.scaleX = 1.6987766126222235;
        rectangle_1.scaleY = 1.5897100335089185;
        rectangle_1.setOrigin(0.5656644307716621, 0.7371627542639345);
