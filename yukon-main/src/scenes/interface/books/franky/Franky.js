...
export const preload = {
    ...
    loadString: ['loading', 'Frankys First Show']
}
// You can write more code here

/* START OF COMPILED CODE */

export default class Franky extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // page12
        const page12 = scene.add.image(-32.81854248046875, -19.229248046875, "franky", "frankypg7");
        page_1.add(page12);

        // backPageLeft
        const backPageLeft = scene.add.sprite(-204, 204, "franky", "backPageLeft");
        page_1.add(backPageLeft);

        // text_1
        const text_1 = scene.add.text(250, -456, "", {});
        text_1.text = "x";
        text_1.setStyle({ "fontFamily": "Helvetica", "fontSize": "48px", "fontStyle": "bold" });
        page_1.add(text_1);
        ...
        // page6
        const page6 = scene.add.image(-31.81854248046875, -19.229248046875, "franky", "frankypg6");
        page_6.add(page6);
        ...
        // page5
        const page5 = scene.add.image(-31.81854248046875, -19.229248046875, "franky", "frankypg5");
        page_5.add(page5);
        ...
        // page44
        const page44 = scene.add.image(-32.81854248046875, -19.229248046875, "franky", "frankypg4");
        page4.add(page44);
        ...
        // page33
        const page33 = scene.add.image(-31.81854248046875, -18.229248046875, "franky", "frankypg3");
        page3.add(page33);

        // page2
        const page2 = scene.add.container(792.8185267235533, 500.22924628614487);
        page2.visible = false;
        this.add(page2);

        // page22
        const page22 = scene.add.image(-32.81854248046875, -19.229248046875, "franky", "frankypg2");
        page2.add(page22);
        ...
        // page
        const page = scene.add.image(-33, -19, "franky", "frankypg1");
        page1.add(page);

        // closeRightFront
        const closeRightFront = scene.add.sprite(211, -347, "pagebuttons", "closeRight");
        page1.add(closeRightFront);

        // makeshift move page
        const makeshift_move_page = scene.add.rectangle(-3, 41, 600, 700);
        ...
        // rectangle_2
        const rectangle_2 = scene.add.rectangle(1434, 312, 128, 128);
        ...
        // rectangle_3
        const rectangle_3 = scene.add.rectangle(1209, -2, 50, 128);
        ...
        // lists
        const pages = [page1, page2, page3, page4, page_5, page_6, page_1];
