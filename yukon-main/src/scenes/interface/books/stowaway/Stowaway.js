...
export const preload = {
    ...
    loadString: ['loading', 'Rockhopper and the Stowaway']
}
// You can write more code here

/* START OF COMPILED CODE */

export default class Stowaway extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // page12
        const page12 = scene.add.image(-32.81854248046875, -19.229248046875, "stowawaybook", "stowawaypg9");
        page_1.add(page12);

        // backPageLeft
        const backPageLeft = scene.add.sprite(-204, 204, "stowawaybook", "backPageLeft");
        page_1.add(backPageLeft);

        // text_1
        const text_1 = scene.add.text(258, -462, "", {});
        text_1.text = "x";
        ...
        // page8
        const page8 = scene.add.image(-31.81854248046875, -20.229248046875, "stowawaybook", "stowawaypg8");
        page_8.add(page8);

        // bracelet
        const bracelet = scene.add.image(251, 133, "stowawaybook", "bracelet");
        page_8.add(bracelet);
        ...
        // page7
        const page7 = scene.add.image(-31.81854248046875, -20.229248046875, "stowawaybook", "stowawaypg7");
        page_7.add(page7);
        ...
        // page6
        const page6 = scene.add.image(-30.81854248046875, -20.229248046875, "stowawaybook", "stowawaypg6");
        page_6.add(page6);
        ...
        // page5
        const page5 = scene.add.image(-31.81854248046875, -20.229248046875, "stowawaybook", "stowawaypg5");
        page_5.add(page5);
        ...
        // page44
        const page44 = scene.add.image(-31.81854248046875, -20.229248046875, "stowawaybook", "stowawaypg4");
        page4.add(page44);
        ...
        // page33
        const page33 = scene.add.image(-31.81854248046875, -19.229248046875, "stowawaybook", "stowawaypg3");
        page3.add(page33);
        ...
        // page22
        const page22 = scene.add.image(-32.81854248046875, -19.229248046875, "stowawaybook", "stowawaypg2");
        page2.add(page22);
        ...
        // page
        const page = scene.add.image(-33, -19, "stowawaybook", "stowawaypg1");
        page1.add(page);
        ...
        // rectangle_3
        const rectangle_3 = scene.add.rectangle(1207, -3, 50, 128);
        ...
        // lists
        const pages = [page1, page2, page3, page4, page_5, page_6, page_7, page_8, page_1];
        ...
        // bracelet (components)
        const braceletButton = new Button(bracelet);
        braceletButton.spriteName = "bracelet";
        braceletButton.callback = () =>this.interface.prompt.showItem(339);
