...
export default class BuyButton extends BaseImage {
    ...
    constructor(scene, x, y, texture, frame) {
        super(scene, x ?? 0, y ?? 0, texture || "commonbook", frame ?? "cc-buy3");

        /** @type {number} */
        this.item = 0;
        /** @type {"Clothing"|"Furniture"|"Flooring"|"Igloo"|"Igloo Location"} */
    ...
    buy() {
        switch(this.itemType) {
            ...
            case "Flooring":
                ...
                break
            case "Igloo":
                this.interface.prompt.showIgloo(this.item)
                break
            case "Igloo Location":
