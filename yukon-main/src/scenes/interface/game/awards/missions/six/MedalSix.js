...
export const preload = {
    key: 'medalsix-pack',
    url: 'assets/media/interface/game/awards/missions/six/medalsix-pack.json',
    loadString: ['loading', 'award_q6_medal']
}

/* START OF COMPILED CODE */

export default class MedalSix extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "award_q6_medal");
        this.add(bg);
