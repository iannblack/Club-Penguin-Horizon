...
export const preload = {
    key: 'medalone-pack',
    url: 'assets/media/interface/game/awards/missions/one/medalone-pack.json',
    loadString: ['loading', 'award_q1_medal']
}

/* START OF COMPILED CODE */

export default class MedalOne extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "award_q1_medal");
        this.add(bg);
