...
export const preload = {
    key: 'gifttwo-pack',
    url: 'assets/media/interface/game/awards/missions/two/gifttwo-pack.json',
    loadString: ['loading', 'award_q2_gift']
}

/* START OF COMPILED CODE */

export default class GiftTwo extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(-8, -2, "award_q2_gift");
        this.add(bg);

        // buttons_close
        const buttons_close = scene.add.image(285, -397, "main", "grey-button");
        this.add(buttons_close);

        // grey_x
        const grey_x = scene.add.image(285, -399, "main", "grey-x");
        this.add(grey_x);
