...
export const preload = {
    key: 'medalfour-pack',
    url: 'assets/media/interface/game/awards/missions/four/medalfour-pack.json',
    loadString: ['loading', 'award_q4_medal']
}

/* START OF COMPILED CODE */

export default class MedalFour extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "award_q4_medal");
        this.add(bg);
