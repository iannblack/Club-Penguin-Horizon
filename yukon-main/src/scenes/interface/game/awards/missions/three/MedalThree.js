...
export const preload = {
    key: 'medalthree-pack',
    url: 'assets/media/interface/game/awards/missions/three/medalthree-pack.json',
    loadString: ['loading', 'award_q3_medal']
}

/* START OF COMPILED CODE */

export default class MedalThree extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "award_q3_medal");
        this.add(bg);
