...
export const preload = {
    key: 'medalten-pack',
    url: 'assets/media/interface/game/awards/missions/ten/medalten-pack.json',
    loadString: ['loading', 'award_q10_medal']
}

/* START OF COMPILED CODE */

export default class MedalTen extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "award_q10_medal");
        this.add(bg);
