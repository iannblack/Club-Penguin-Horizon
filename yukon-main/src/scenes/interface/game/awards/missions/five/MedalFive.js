...
export const preload = {
    key: 'medalfive-pack',
    url: 'assets/media/interface/game/awards/missions/five/medalfive-pack.json',
    loadString: ['loading', 'award_q5_medal']
}

/* START OF COMPILED CODE */

export default class MedalFive extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "award_q5_medal");
        this.add(bg);
