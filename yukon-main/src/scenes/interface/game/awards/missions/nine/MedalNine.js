...
export const preload = {
    key: 'medalnine-pack',
    url: 'assets/media/interface/game/awards/missions/nine/medalnine-pack.json',
    loadString: ['loading', 'award_q9_medal']
}

/* START OF COMPILED CODE */

export default class MedalNine extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "award_q9_medal");
        this.add(bg);
