...
export const preload = {
    key: 'medaleight-pack',
    url: 'assets/media/interface/game/awards/missions/eight/medaleight-pack.json',
    loadString: ['loading', 'award_q8_medal']
}

/* START OF COMPILED CODE */

export default class MedalEight extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "award_q8_medal");
        this.add(bg);
