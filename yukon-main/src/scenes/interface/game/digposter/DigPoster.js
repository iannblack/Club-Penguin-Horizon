...
export const preload = {
    key: 'digposter-pack',
    url: 'assets/media/interface/game/digposter/digposter-pack.json',
    loadString: ['loading', 'digposter']
}

/* START OF COMPILED CODE */

export default class DigPoster extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(11, -2, "digposter", "bg");
        this.add(bg);

        // buttons_close
        const buttons_close = scene.add.image(384, -407, "digposter", "buttons/close");
        ...
        buttons_closeButton.spriteName = "buttons/close";
