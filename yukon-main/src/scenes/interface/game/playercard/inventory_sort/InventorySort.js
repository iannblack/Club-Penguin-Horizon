...
export default class InventorySort extends FloatingMenu {
    ...
    constructor(scene, x, y) {
        ...
        all_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        this.add(all_text);
        ...
        other_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        this.add(other_text);
        ...
        colors_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        ...
        feet_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        this.add(feet_text);
        ...
        hand_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        this.add(hand_text);
        ...
        body_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        this.add(body_text);
        ...
        neck_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        this.add(neck_text);
        ...
        face_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        this.add(face_text);
        ...
        head_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fixedHeight":26,"fontFamily": "Arial", "fontSize": "24px" });
        this.add(head_text);
        ...
        // inventory_list_item12
        const inventory_list_item12 = scene.add.image(0, -64, "main", "list/small");
        other_container.add(inventory_list_item12);
        ...
        const transformations_text = scene.add.text(0, 64, "", {});
        transformations_text.setOrigin(0.5, 0.5);
        transformations_text.text = "Transformations";
        transformations_text.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":268,"fontFamily": "Arial", "fontSize": "24px" });
        other_container.add(transformations_text);
        ...
        // awards_text
        const awards_text = scene.add.text(3, -64, "", {});
        ...
        inventory_list_item_10Button.callback = () => this.filterInventory('Transformations', 'transforms');
        ...
        // inventory_list_item12 (components)
        const inventory_list_item12Button = new Button(inventory_list_item12);
        inventory_list_item12Button.spriteName = "list/small";
        inventory_list_item12Button.callback = () => this.filterInventory('Awards', 'award');
    ...
    showMenu() {
        ...
        this.visible = true
        document.getElementById('inventoryFilter').style.visibility = 'hidden'
    }

    closeMenu() {
        this.other_container.visible = false
        this.visible = false
        document.getElementById('inventoryFilter').style.visibility = 'visible'
    }
