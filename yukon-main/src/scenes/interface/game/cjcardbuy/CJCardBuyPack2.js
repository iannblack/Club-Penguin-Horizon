...
export default class CJCardBuyPack2 extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // pack1cjcard2
        const pack1cjcard2 = new CJCard(scene, 0, 532);
        pack1cjcard2.scaleX = 1.5;
        pack1cjcard2.scaleY = 1.5;
        pack1cjcard2.visible = false;
        this.add(pack1cjcard2);

        // pack1cjcard3
        const pack1cjcard3 = new CJCard(scene, 0, 532);
        pack1cjcard3.scaleX = 1.5;
        pack1cjcard3.scaleY = 1.5;
        pack1cjcard3.visible = false;
        this.add(pack1cjcard3);
        ...
        // pack1pack
        const pack1pack = scene.add.image(0, 874.5, "cjcardbuy-card2", "cardbg");
        pack1pack.scaleX = 0.7385;
        pack1pack.scaleY = 0.7385;
        this.add(pack1pack);

        // pack1slicetopoff
        const pack1slicetopoff = scene.add.sprite(407, -120, "cjcardbuy-card2", "openanim0001");
        pack1slicetopoff.visible = false;
        this.add(pack1slicetopoff);

        // pack1pack_1
        const pack1pack_1 = scene.add.image(0, 817, "cjcardbuy-card2", "cardbg");
        ...
        this.pack1cjcard2 = pack1cjcard2;
        this.pack1cjcard3 = pack1cjcard3;
                            ...
                            this.scene.tweens.add({
                                ...
                                onComplete: () => {
                                    this.scene.tweens.add({
                                        ...
                                        duration    : 166,
                                        onComplete: () => {
                                            this.pack1cjcard2.visible = true
                                            this.pack1cjcard2.setupCard(0)
                                            this.pack1cjcard3.visible = true
                                            this.pack1cjcard3.setupCard(0)
                                            this.pack1cjcard3.x = this.pack1cjcard2.x = this.pack1cjcard.x
                                            this.pack1cjcard3.y = this.pack1cjcard2.y = this.pack1cjcard.y
                                            this.pack1cjcard3.scaleX = this.pack1cjcard2.scaleX = this.pack1cjcard.scaleX
                                            this.pack1cjcard2.scaleY = this.pack1cjcard2.scaleY = this.pack1cjcard.scaleY

                                            this.scene.tweens.add({
                                                targets     : this.pack1cjcard2,
                                                x: -500,
                                                //ease        : Phaser.Math.Easing.Quadratic.InOut,
                                                duration    : 625,
                                                onComplete: () => {
    ...
    buyPack1Step3() {
        ...
        this.scene.tweens.add({
            ...
            duration    : 208,
            onComplete: () => {
                this.pack1cjcard.setupCard(cardToGet[0])
                this.scene.tweens.add({
                    targets     : this.pack1cjcard,
                    scaleX: 1.5,
                    //ease        : Phaser.Math.Easing.Quadratic.InOut,
        ...
        this.scene.tweens.add({
            ...
            duration    : 208,
            onComplete: () => {
                this.pack1cjcard2.setupCard(cardToGet[1])
                this.scene.tweens.add({
                    targets     : this.pack1cjcard2,
                    scaleX: 1.5,
                    //ease        : Phaser.Math.Easing.Quadratic.InOut,
        ...
        this.scene.tweens.add({
            ...
            duration    : 208,
            onComplete: () => {
                this.pack1cjcard3.setupCard(cardToGet[2])
                this.scene.tweens.add({
                    targets     : this.pack1cjcard3,
                    scaleX: 1.5,
                    //ease        : Phaser.Math.Easing.Quadratic.InOut,
