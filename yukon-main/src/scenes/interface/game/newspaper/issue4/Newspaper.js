...
export const preload = {
    key: 'fourth-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/fourth edition/fourth-edition-pack.json',
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // page4
        const page4 = scene.add.image(67, 60, "fourth-edition", "test0083");
        _page4.add(page4);
        ...
        // page3
        const page3 = scene.add.image(83, 90, "fourth-edition", "test0032");
        _page3.add(page3);
        ...
        // page2
        const page2 = scene.add.image(83, 91, "fourth-edition", "test0019");
        _page2.add(page2);
        ...
        // page1
        const page1 = scene.add.image(87, 62, "fourth-edition", "test0001");
        _page1.add(page1);
        ...
        mancallySimpleButton.callback = () => {this.showPage(2)};

        // snowkitten (components)
        const snowkittenSimpleButton = new SimpleButton(snowkitten);
        snowkittenSimpleButton.callback = () => {this.showPage(1)};
