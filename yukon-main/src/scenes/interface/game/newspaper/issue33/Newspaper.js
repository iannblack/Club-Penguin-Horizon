...
export const preload = {
    key: 'issue33-pack',
    url: 'assets/media/interface/game/newspaper/issue33/issue33-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // aaarttetxtmerrrrr
        const aaarttetxtmerrrrr = scene.add.text(-25, 26, "", {});
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(97, 59, "issue33", "issue33-pg8");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(97, 59, "issue33", "issue33-pg7");
        _page8.add(adaptedpg5);

        // submit_btn_2
        const submit_btn_2 = scene.add.image(599, 392, "newspaper-common", "submit-btn");
        submit_btn_2.scaleX = 0.55;
        submit_btn_2.scaleY = 0.55;
        _page8.add(submit_btn_2);

        // askaapagetext
        const askaapagetext = scene.add.text(510, 379, "", {});
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(97, 59, "issue33", "issue33-pg6");
        ...
        // page3_and_halff
        const page3_and_halff = scene.add.image(97, 59, "issue33", "issue33-pg5");
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(97, 59, "issue33", "issue33-pg4");
        ...
        // page3
        const page3 = scene.add.image(97, 59, "issue33", "issue33-pg3");
        _page3.add(page3);

        // rectangle_2
        const rectangle_2 = scene.add.rectangle(-64, 113, 210, 80);
        _page3.add(rectangle_2);

        // herbertNote
        const herbertNote = scene.add.image(94, 75, "issue33", "herbert-note");
        herbertNote.visible = false;
        _page3.add(herbertNote);
        ...
        // issue33_pg2
        const issue33_pg2 = scene.add.image(97, 59, "issue33", "issue33-pg2");
        _page2.add(issue33_pg2);
        ...
        // issue33_pg1
        const issue33_pg1 = scene.add.image(97, 30, "issue33", "issue33-pg1");
        _page1.add(issue33_pg1);
        ...
        rectangle_2SimpleButton.callback = () => this.herbertNote.visible = true;

        // herbertNote (components)
        const herbertNoteSimpleButton = new SimpleButton(herbertNote);
        herbertNoteSimpleButton.callback = () => this.herbertNote.visible = false;
        herbertNoteSimpleButton.pixelPerfect = true;
        ...
        constructionSimpleButton.callback = () => {this.showPage(2)};
    ...
    showPage(p) {
        super.showPage(p)
        this.herbertNote.visible = false
    }
