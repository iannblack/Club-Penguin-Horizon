...
export const preload = {
    key: 'second-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/second edition/second-edition-pack.json',
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // page4
        const page4 = scene.add.image(0, 0, "second-edition", "page4");
        _page4.add(page4);
        ...
        // page3
        const page3 = scene.add.image(0, 0, "second-edition", "page3");
        _page3.add(page3);
        ...
        // page2
        const page2 = scene.add.image(0, 0, "second-edition", "page2");
        _page2.add(page2);
        ...
        // page1
        const page1 = scene.add.image(0, 0, "second-edition", "page1");
        _page1.add(page1);
