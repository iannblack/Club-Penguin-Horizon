...
export const preload = {
    key: 'eighth-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/eighth edition/eighth-edition-pack.json',
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // page4
        const page4 = scene.add.image(74, 59, "eighth-edition", "paper0026");
        _page4.add(page4);
        ...
        // page3
        const page3 = scene.add.image(91, 89, "eighth-edition", "paper0019");
        _page3.add(page3);
        ...
        // page2
        const page2 = scene.add.image(91, 90, "eighth-edition", "paper0011");
        _page2.add(page2);
        ...
        // page1
        const page1 = scene.add.image(96, 61, "eighth-edition", "paper0001");
        _page1.add(page1);
