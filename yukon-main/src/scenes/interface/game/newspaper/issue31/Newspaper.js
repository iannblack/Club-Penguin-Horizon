...
export const preload = {
    key: 'issue31-pack',
    url: 'assets/media/interface/game/newspaper/issue31/issue31-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(97, 59, "issue31", "issue31-pg8");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(97, 59, "issue31", "issue31-pg7");
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(97, 59, "issue31", "issue31-pg6");
        ...
        // page3_and_halff
        const page3_and_halff = scene.add.image(97, 59, "issue31", "issue31-pg5");
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(97, 59, "issue31", "issue31-pg4");
        ...
        // page3
        const page3 = scene.add.image(97, 59, "issue31", "issue31-pg3");
        _page3.add(page3);
        ...
        // issue31_pg2
        const issue31_pg2 = scene.add.image(97, 59, "issue31", "issue31-pg2");
        _page2.add(issue31_pg2);
        ...
        // issue31_pg1
        const issue31_pg1 = scene.add.image(97, 30, "issue31", "issue31-pg1");
        _page1.add(issue31_pg1);
