...
export const preload = {
    key: 'issue24-pack',
    url: 'assets/media/interface/game/newspaper/issue24/issue24-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // close_232
        const close_232 = scene.add.image(724, -248, "newspaper-common", "close");
        close_232.angle = -1;
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(97, 59, "issue24", "issue24-pg8");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(97, 59, "issue24", "issue24-pg7");
        _page8.add(adaptedpg5);

        // submit_btn_2
        const submit_btn_2 = scene.add.image(603, 391, "newspaper-common", "submit-btn");
        submit_btn_2.scaleX = 0.55;
        submit_btn_2.scaleY = 0.55;
        _page8.add(submit_btn_2);

        // askaapagetext
        const askaapagetext = scene.add.text(514, 378, "", {});
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(97, 59, "issue24", "issue24-pg6");
        ...
        // _page6andhalf
        const _page6andhalf = scene.add.container(676, 406);
        _page6andhalf.visible = false;
        this.add(_page6andhalf);

        // page3_and_halffff
        const page3_and_halffff = scene.add.image(29, 48, "newspaper-common", "artwork-pg");
        _page6andhalf.add(page3_and_halffff);
        ...
        _page6andhalf.add(aunt_Pikachu);
        ...
        _page6andhalf.add(aunt_Pikachu_2);
        ...
        _page6andhalf.add(aunt_Pikachu_1);
        ...
        // page3_and_halff
        const page3_and_halff = scene.add.image(97, 59, "issue24", "issue24-pg5");
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(97, 59, "issue24", "issue24-pg4");
        _page4.add(page3_and_half);

        // submit_btn_3
        const submit_btn_3 = scene.add.image(-269, -20, "newspaper-common", "submit-btn");
        submit_btn_3.scaleX = 0.8004784045139945;
        submit_btn_3.scaleY = 0.9693010538677147;
        submit_btn_3.visible = false;
        submit_btn_3.tintTopLeft = 16777215;
        submit_btn_3.tintTopRight = 16777215;
        submit_btn_3.tintBottomLeft = 16777215;
        submit_btn_3.tintBottomRight = 16777215;
        _page4.add(submit_btn_3);

        // askaapagetext_1
        const askaapagetext_1 = scene.add.text(-362, -59, "", {});
        askaapagetext_1.visible = false;
        askaapagetext_1.text = "Submit Your\nPainting!";
        askaapagetext_1.setStyle({ "align": "center", "color": "#552c00ff", "fontFamily": "Burbank Small", "fontSize": "32px", "fontStyle": "bold" });
        _page4.add(askaapagetext_1);
        ...
        // page3
        const page3 = scene.add.image(97, 59, "issue24", "issue24-pg3");
        _page3.add(page3);
        ...
        // issue24_pg2
        const issue24_pg2 = scene.add.image(97, 59, "issue24", "issue24-pg2");
        _page2.add(issue24_pg2);
        ...
        // issue24_pg1
        const issue24_pg1 = scene.add.image(97, 30, "issue24", "issue24-pg1");
        _page1.add(issue24_pg1);
        ...
        submit_btn_3Button.callback = () => this.onSubmit('painting');
        ...
        insideBtn_4SimpleButton.callback = () => {this.showPage(3)};
