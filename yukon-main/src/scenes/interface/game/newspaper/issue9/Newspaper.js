...
export const preload = {
    key: 'ninth-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/ninth edition/ninth-edition-pack.json',
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // page4
        const page4 = scene.add.image(75, 10, "newspaper-issue9", "issue9page0026");
        _page4.add(page4);
        ...
        // page3
        const page3 = scene.add.image(91, 41, "newspaper-issue9", "issue9page0019");
        _page3.add(page3);
        ...
        // page2
        const page2 = scene.add.image(92, 42, "newspaper-issue9", "issue9page0011");
        _page2.add(page2);

        // interview0001
        const interview0001 = scene.add.image(416, 40, "newspaper-issue9", "interview0001");
        ...
        // page1
        const page1 = scene.add.image(96, 13, "newspaper-issue9", "issue9page0001");
        _page1.add(page1);
    ...
    onInterview() {
		this.interviewSlide++
		if(this.interviewSlide > 11) this.interviewSlide = 1
