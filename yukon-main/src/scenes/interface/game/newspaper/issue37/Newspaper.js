...
export const preload = {
    key: 'issue37-pack',
    url: 'assets/media/interface/game/newspaper/issue37/issue37-pack.json', 
...
export default class Newspaper extends BaseNewspaper {
    ...
    constructor(scene, x, y) {
        ...
        // pg10
        const pg10 = scene.add.image(97, 59, "issue37", "issue37-pg10");
        _page10.add(pg10);
        ...
        // pg9
        const pg9 = scene.add.image(97, 59, "issue37", "issue37-pg9");
        _page9.add(pg9);

        // shuffle
        const shuffle = new Shuffle(scene, 368, 107);
        _page9.add(shuffle);
        ...
        // pg7
        const pg7 = scene.add.image(97, 59, "issue37", "issue37-pg7");
        _page7.add(pg7);

        // submit_btn_2
        const submit_btn_2 = scene.add.image(588, 382, "news-common", "submit-btn");
        submit_btn_2.scaleX = 0.55;
        submit_btn_2.scaleY = 0.55;
        _page7.add(submit_btn_2);

        // askaapagetext
        const askaapagetext = scene.add.text(499, 369, "", {});
        ...
        // pg6
        const pg6 = scene.add.image(97, 59, "issue37", "issue37-pg6");
        _page6.add(pg6);
        ...
        // pg5
        const pg5 = scene.add.image(97, 59, "issue37", "issue37-pg5");
        _page5.add(pg5);
        ...
        // pg4
        const pg4 = scene.add.image(97, 59, "issue37", "issue37-pg4");
        _page4.add(pg4);
        ...
        // pg3
        const pg3 = scene.add.image(97, 59, "issue37", "issue37-pg3");
        _page3.add(pg3);
        ...
        // pg2
        const pg2 = scene.add.image(97, 59, "issue37", "issue37-pg2");
        _page2.add(pg2);
        ...
        // pg1
        const pg1 = scene.add.image(97, 30, "issue37", "issue37-pg1");
        _page1.add(pg1);
        ...
        // insideBtn1
        const insideBtn1 = scene.add.rectangle(-360, 110, 128, 128);
        ...
        // insideBtn2
        const insideBtn2 = scene.add.rectangle(-359, 143, 128, 128);
        ...
        // insideBtn3
        const insideBtn3 = scene.add.rectangle(-360, 179, 128, 128);
        ...
        // insideBtn4
        const insideBtn4 = scene.add.rectangle(-360, 216, 128, 128);
        ...
        // insideBtn5
        const insideBtn5 = scene.add.rectangle(-360, 251, 128, 128);
        ...
        // insideBtn6
        const insideBtn6 = scene.add.rectangle(-360, 284, 128, 128);
        ...
        // insideBtn7
        const insideBtn7 = scene.add.rectangle(-360, 316, 128, 128);
        ...
        // insideBtn8
        const insideBtn8 = scene.add.rectangle(-360, 349, 128, 128);
        ...
        questionsSimpleButton.callback = () => {this.showPage(4)};
        ...
        insideBtn2SimpleButton.callback = () => {this.showPage(3)};
        ...
        insideBtn3SimpleButton.callback = () => {this.showPage(4)};
        ...
        insideBtn4SimpleButton.callback = () => {this.showPage(5)};
        ...
        insideBtn5SimpleButton.callback = () => {this.showPage(7)};
        ...
        insideBtn7SimpleButton.callback = () => {this.showPage(8)};
        ...
        insideBtn8SimpleButton.callback = () => {this.showPage(9)};
