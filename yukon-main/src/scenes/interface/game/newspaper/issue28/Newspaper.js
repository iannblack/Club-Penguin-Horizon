...
export const preload = {
    key: 'issue28-pack',
    url: 'assets/media/interface/game/newspaper/issue28/issue28-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(97, 59, "issue28", "issue28-pg8");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(97, 59, "issue28", "issue28-pg7");
        _page8.add(adaptedpg5);

        // submit_btn_2
        const submit_btn_2 = scene.add.image(594, 406, "newspaper-common", "submit-btn");
        submit_btn_2.scaleX = 0.55;
        submit_btn_2.scaleY = 0.55;
        _page8.add(submit_btn_2);

        // askaapagetext
        const askaapagetext = scene.add.text(505, 393, "", {});
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(97, 59, "issue28", "issue28-pg6");
        ...
        // page3_and_halff
        const page3_and_halff = scene.add.image(97, 59, "issue28", "issue28-pg5");
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(97, 59, "issue28", "issue28-pg4");
        ...
        // page3
        const page3 = scene.add.image(97, 59, "issue28", "issue28-pg3");
        _page3.add(page3);
        ...
        // issue28_pg2
        const issue28_pg2 = scene.add.image(97, 59, "issue28", "issue28-pg2");
        _page2.add(issue28_pg2);
        ...
        // issue28_pg1
        const issue28_pg1 = scene.add.image(97, 30, "issue28", "issue28-pg1");
        _page1.add(issue28_pg1);
