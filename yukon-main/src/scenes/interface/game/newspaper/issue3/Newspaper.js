...
export const preload = {
    key: 'third-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/third edition/third-edition-pack.json',
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // _page4
        const _page4 = scene.add.container(712, 439);
        _page4.visible = false;
        this.add(_page4);

        // page4
        const page4 = scene.add.image(65, 62, "third-edition", "page4");
        _page4.add(page4);

        // left_12
        const left_12 = scene.add.image(-594, 323, "newspaperbuttons", "left");
        _page4.add(left_12);

        // close_23
        const close_23 = scene.add.image(694, -298, "newspaperbuttons", "close");
        _page4.add(close_23);

        // main_1
        const main_1 = scene.add.image(-594, -253, "newspaperbuttons", "main");
        _page4.add(main_1);
        ...
        // page3
        const page3 = scene.add.image(87, 88, "third-edition", "page3");
        _page3.add(page3);
        ...
        // page2
        const page2 = scene.add.image(89, 91, "third-edition", "page2");
        _page2.add(page2);

        // rectangle_2
        const rectangle_2 = scene.add.rectangle(408, -116, 278, 89);
        rectangle_2.alpha = 0.00001;
        rectangle_2.isFilled = true;
        _page2.add(rectangle_2);
        ...
        // page1
        const page1 = scene.add.image(90, 63, "third-edition", "page1");
        _page1.add(page1);
        ...
        // right
        const right = scene.add.image(1410, 779, "newspaperbuttons", "right");
        buttons.add(right);

        // main
        const main = scene.add.image(113, 227, "newspaperbuttons", "main");
        buttons.add(main);

        // left
        const left = scene.add.image(113, 804, "newspaperbuttons", "left");
        buttons.add(left);

        // close
        const close = scene.add.image(1402, 182, "newspaperbuttons", "close");
        buttons.add(close);
        ...
        rectangle_2SimpleButton.callback = () => this.interface.prompt.showError("The background from this copy\nhas already been taken.");
