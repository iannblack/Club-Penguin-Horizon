...
export const preload = {
    key: 'issue39-pack',
    url: 'assets/media/interface/game/newspaper/issue39/issue39-pack.json', 
...
export default class Newspaper extends BaseNewspaper {
    ...
    constructor(scene, x, y) {
        ...
        // pg10
        const pg10 = scene.add.image(97, 59, "issue39", "issue39-pg9");
        _page10.add(pg10);
        ...
        // claw
        const claw = scene.add.image(450, 39, "issue39", "claw");
        claw.flipX = true;
        _page9.add(claw);
        ...
        // pg8
        const pg8 = scene.add.image(97, 59, "issue39", "issue39-pg8");
        _page8.add(pg8);

        // shuffle
        const shuffle = new Shuffle(scene, 368, 103);
        _page8.add(shuffle);
        ...
        // pg7
        const pg7 = scene.add.image(97, 59, "issue39", "issue39-pg7");
        _page7.add(pg7);

        // answerKeyTxt
        const answerKeyTxt = scene.add.text(-236, 259, "", {});
        ...
        answerKeyTxt_2.text = "1. Because I'm a clock\n2. A parking lot\n3. Time";
        ...
        // pg6
        const pg6 = scene.add.image(97, 59, "issue39", "issue39-pg6");
        _page6.add(pg6);
        ...
        // pg5
        const pg5 = scene.add.image(97, 59, "issue39", "issue39-pg5");
        _page5.add(pg5);
        ...
        // pg4
        const pg4 = scene.add.image(97, 59, "issue39", "issue39-pg4");
        _page4.add(pg4);
        ...
        // pg3
        const pg3 = scene.add.image(97, 59, "issue39", "issue39-pg3");
        _page3.add(pg3);
        ...
        // pg2
        const pg2 = scene.add.image(97, 59, "issue39", "issue39-pg2");
        _page2.add(pg2);
        ...
        // pg1
        const pg1 = scene.add.image(97, 30, "issue39", "issue39-pg1");
        _page1.add(pg1);
