...
export const preload = {
    key: 'issue22-pack.json',
    url: 'assets/media/interface/game/newspaper/issue22/issue22-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(29, 48, "issue22", "issue22-pg0007");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(29, 48, "issue22", "issue22-pg0006");
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(29, 48, "issue22", "issue22-pg0005");
        ...
        // melondude
        const melondude = scene.add.image(437, 30, "Melondude");
        melondude.scaleX = 1.2;
        melondude.scaleY = 1.2;
        melondude.angle = -1;
        _page6.add(melondude);

        // allaska
        const allaska = scene.add.image(-297, 279, "Allaska");
        allaska.scaleX = 0.8;
        allaska.scaleY = 0.8;
        allaska.angle = -1;
        _page6.add(allaska);
        ...
        // mochiMochi
        const mochiMochi = scene.add.image(-265, -72, "MochiMochi");
        mochiMochi.scaleX = 0.9;
        mochiMochi.scaleY = 0.9;
        mochiMochi.angle = -1;
        _page6.add(mochiMochi);

        // artCredit1
        const artCredit1 = scene.add.text(351, 293, "", {});
        artCredit1.angle = -1;
        artCredit1.text = "Melondude";
        ...
        // artCredit_1
        const artCredit_1 = scene.add.text(-207, 373, "", {});
        artCredit_1.angle = -1;
        artCredit_1.text = "Allaska";
        artCredit_1.setStyle({ "fontFamily": "Burbank Small", "fontSize": "60px", "fontStyle": "bold", "stroke": "#000", "strokeThickness":20});
        _page6.add(artCredit_1);

        // artCredit_2
        const artCredit_2 = scene.add.text(-606, -263, "", {});
        artCredit_2.angle = -1;
        artCredit_2.text = "MochiMochi";
        ...
        // spoder
        const spoder = scene.add.image(46, 55, "spoder");
        spoder.scaleX = 1.2;
        spoder.scaleY = 1.2;
        spoder.angle = -1;
        _page5.add(spoder);
        ...
        // artCredit
        const artCredit = scene.add.text(424, 340, "", {});
        artCredit.angle = -1;
        artCredit.text = "Spoder";
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(29, 48, "issue22", "issue22-pg0004");
        ...
        // page3
        const page3 = scene.add.image(29, 48, "issue22", "issue22-pg0003");
        _page3.add(page3);
        ...
        // page2
        const page2 = scene.add.image(29, 48, "issue22", "issue22-pg0002");
        _page2.add(page2);
        ...
        // adaptedpg1
        const adaptedpg1 = scene.add.image(31, 10, "issue22", "issue22-pg0001");
