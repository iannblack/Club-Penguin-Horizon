...
export const preload = {
    key: 'seventeenth-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/seventeenth-edition/seventeenth-edition-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(106, 107, "seventeenth-edition-pics", "newspaper_seventeen0025");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(106, 107, "seventeenth-edition-pics", "newspaper_seventeen0021");
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(106, 107, "seventeenth-edition-pics", "newspaper_seventeen0017");
        ...
        // _page3_and_a_half
        const _page3_and_a_half = scene.add.container(676, 407);
        _page3_and_a_half.visible = false;
        this.add(_page3_and_a_half);

        // page3_and_half
        const page3_and_half = scene.add.image(106, 107, "seventeenth-edition-pics", "newspaper_seventeen0013");
        ...
        // page3
        const page3 = scene.add.image(106, 107, "seventeenth-edition-pics", "newspaper_seventeen0009");
        _page3.add(page3);
        ...
        // page2
        const page2 = scene.add.image(106, 107, "seventeenth-edition-pics", "newspaper_seventeen0005");
        _page2.add(page2);
        ...
        // adaptedpg1
        const adaptedpg1 = scene.add.image(107, 72, "seventeenth-edition-pics", "newspaper_seventeen0001");
        ...
        // construction
        const construction = scene.add.rectangle(-269, -80, 131, 139);
