...
export const preload = {
    key: 'issue36-pack',
    url: 'assets/media/interface/game/newspaper/issue36/issue36-pack.json', 
...
export default class Newspaper extends BaseNewspaper {
    ...
    constructor(scene, x, y) {
        ...
        // pg10
        const pg10 = scene.add.image(97, 59, "news-common", "submit-content-pg");
        _page10.add(pg10);
        ...
        // pg9
        const pg9 = scene.add.image(97, 59, "issue36", "issue36-pg8");
        _page9.add(pg9);
        ...
        // sudokupuffle
        const sudokupuffle = scene.add.image(-110, 311, "issue36", "sudokupuffle");
        _page8.add(sudokupuffle);

        // sudoku
        const sudoku = new Sudoku(scene, 111, -248);
        _page8.add(sudoku);
        ...
        // pg7
        const pg7 = scene.add.image(97, 59, "issue36", "issue36-pg7");
        _page7.add(pg7);

        // answerKeyTxt
        const answerKeyTxt = scene.add.text(-236, 410, "", {});
        ...
        answerKeyTxt_2.text = "1. The match\n2. A candle\n3. A mood";
        ...
        // pg6
        const pg6 = scene.add.image(97, 59, "issue36", "issue36-pg6");
        _page6.add(pg6);
        ...
        // pg5
        const pg5 = scene.add.image(97, 59, "issue36", "issue36-pg5");
        _page5.add(pg5);
        ...
        // pg4
        const pg4 = scene.add.image(97, 59, "issue36", "issue36-pg4");
        _page4.add(pg4);
        ...
        // pg3
        const pg3 = scene.add.image(97, 59, "issue36", "issue36-pg3");
        _page3.add(pg3);
        ...
        // pg2
        const pg2 = scene.add.image(97, 59, "issue36", "issue36-pg2");
        _page2.add(pg2);
        ...
        // pg1
        const pg1 = scene.add.image(97, 30, "issue36", "issue36-pg1");
        _page1.add(pg1);
        ...
        // lists
        const pages = [_page1, _page2, _page3, _page4, _page5, _page6, _page7, _page8, _page9, _page10];
