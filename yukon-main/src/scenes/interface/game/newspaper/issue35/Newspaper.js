...
export const preload = {
    key: 'issue35-pack',
    url: 'assets/media/interface/game/newspaper/issue35/issue35-pack.json', 
...
export default class Newspaper extends BaseNewspaper {
    ...
    constructor(scene, x, y) {
        ...
        // page5
        const page5 = scene.add.image(97, 59, "news-common", "submit-content-pg");
        _page10.add(page5);
        ...
        _page10.add(question_submit_btn);
        ...
        _page10.add(questionHoverBubble);
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(97, 59, "issue35", "issue35-pg8");
        _page9.add(adaptedpg6);

        // shuffle
        const shuffle = new Shuffle(scene, -342, 108);
        _page9.add(shuffle);
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(97, 59, "issue35", "issue35-pg7");
        _page7.add(adaptedpg5);
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(97, 59, "issue35", "issue35-pg6");
        _page6.add(adaptedpg2);

        // submit_btn_2
        const submit_btn_2 = scene.add.image(588, 401, "news-common", "submit-btn");
        submit_btn_2.scaleX = 0.55;
        submit_btn_2.scaleY = 0.55;
        _page6.add(submit_btn_2);

        // askaapagetext
        const askaapagetext = scene.add.text(499, 388, "", {});
        ...
        // page3_and_halff
        const page3_and_halff = scene.add.image(97, 59, "issue35", "issue35-pg5");
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(97, 59, "issue35", "issue35-pg4");
        ...
        // page3
        const page3 = scene.add.image(97, 59, "issue35", "issue35-pg3");
        _page3.add(page3);

        // submit_btn
        const submit_btn = scene.add.image(419, 338, "news-common", "submit-btn");
        _page3.add(submit_btn);

        // askaapagetext_1
        const askaapagetext_1 = scene.add.text(303, 306, "", {});
        askaapagetext_1.text = "Go There!";
        askaapagetext_1.setStyle({ "color": "#552c00ff", "fontFamily": "Burbank Small", "fontSize": "50px", "fontStyle": "bold" });
        _page3.add(askaapagetext_1);
        ...
        // issue35_pg2
        const issue35_pg2 = scene.add.image(97, 59, "issue35", "issue35-pg2");
        _page2.add(issue35_pg2);
        ...
        // issue35_pg1
        const issue35_pg1 = scene.add.image(97, 30, "issue35", "issue35-pg1");
        _page1.add(issue35_pg1);
        ...
        // insideBtn1
        const insideBtn1 = scene.add.rectangle(-360, 141, 128, 128);
        ...
        // insideBtn2
        const insideBtn2 = scene.add.rectangle(-360, 176, 128, 128);
        ...
        // insideBtn3
        const insideBtn3 = scene.add.rectangle(-360, 212, 128, 128);
        ...
        // insideBtn4
        const insideBtn4 = scene.add.rectangle(-359, 249, 128, 128);
        ...
        // insideBtn5
        const insideBtn5 = scene.add.rectangle(-359, 284, 128, 128);
        ...
        // insideBtn6
        const insideBtn6 = scene.add.rectangle(-359, 317, 128, 128);
        ...
        // insideBtn7
        const insideBtn7 = scene.add.rectangle(-359, 349, 128, 128);
        ...
        // lists
        const pages = [_page1, _page2, _page3, _page4, _page5, _page6, _page7, _page9, _page10];
        ...
        submit_btnButton.hoverCallback;
        submit_btnButton.hoverOutCallback;
        submit_btnButton.callback = () => this.showPage(8);
