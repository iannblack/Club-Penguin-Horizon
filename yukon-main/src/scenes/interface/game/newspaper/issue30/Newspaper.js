...
export const preload = {
    key: 'issue30-pack',
    url: 'assets/media/interface/game/newspaper/issue30/issue30-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(97, 59, "issue30", "issue30-pg8");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(97, 59, "issue30", "issue30-pg7");
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(97, 59, "issue30", "issue30-pg6");
        ...
        // page3_and_halff
        const page3_and_halff = scene.add.image(97, 59, "issue30", "issue30-pg5");
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(97, 59, "issue30", "issue30-pg4");
        ...
        // page3
        const page3 = scene.add.image(97, 59, "issue30", "issue30-pg3");
        _page3.add(page3);
        ...
        // issue30_pg2
        const issue30_pg2 = scene.add.image(97, 59, "issue30", "issue30-pg2");
        _page2.add(issue30_pg2);
        ...
        // issue30_pg1
        const issue30_pg1 = scene.add.image(97, 30, "issue30", "issue30-pg1");
        _page1.add(issue30_pg1);
