...
export const preload = {
    key: 'issue40-pack',
    url: 'assets/media/interface/game/newspaper/issue40/issue40-pack.json', 
...
export default class Newspaper extends BaseNewspaper {
    ...
    constructor(scene, x, y) {
        ...
        // pg10
        const pg10 = scene.add.image(97, 59, "issue40", "issue40-pg8");
        _page10.add(pg10);
        ...
        // sudoku_puffle
        const sudoku_puffle = scene.add.image(-107, 311, "issue40", "sudoku-puffle");
        ...
        // pg7
        const pg7 = scene.add.image(97, 59, "issue40", "issue40-pg7");
        _page7.add(pg7);
        ...
        answerKeyTxt_2.text = "1. A sponge\n2. Footsteps\n3. Short";
        ...
        // pg6
        const pg6 = scene.add.image(97, 59, "issue40", "issue40-pg6");
        _page6.add(pg6);
        ...
        // pg5
        const pg5 = scene.add.image(97, 59, "issue40", "issue40-pg5");
        _page5.add(pg5);
        ...
        // pg4
        const pg4 = scene.add.image(97, 59, "issue40", "issue40-pg4");
        _page4.add(pg4);
        ...
        // pg3
        const pg3 = scene.add.image(97, 59, "issue40", "issue40-pg3");
        _page3.add(pg3);
        ...
        // pg2
        const pg2 = scene.add.image(97, 59, "issue40", "issue40-pg2");
        _page2.add(pg2);
        ...
        // pg1
        const pg1 = scene.add.image(97, 30, "issue40", "issue40-pg1");
        _page1.add(pg1);
