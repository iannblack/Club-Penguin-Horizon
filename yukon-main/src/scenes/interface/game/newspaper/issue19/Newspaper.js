...
export const preload = {
    key: 'nineteenth-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/nineteenth edition/nineteenth-edition-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(30, 99, "nineteenth-edition", "issue19-page0007");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(30, 99, "nineteenth-edition", "issue19-page0006");
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(30, 99, "nineteenth-edition", "issue19-page0005");
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(30, 99, "nineteenth-edition", "issue19-page0004");
        ...
        // page3
        const page3 = scene.add.image(30, 99, "nineteenth-edition", "issue19-page0003");
        _page3.add(page3);

        // insideBtn
        const insideBtn = scene.add.rectangle(-262, 172, 128, 128);
        insideBtn.scaleX = 2.005485985149811;
        insideBtn.scaleY = 0.3970985433356721;
        insideBtn.angle = -1;
        ...
        // insideBtn_1
        const insideBtn_1 = scene.add.rectangle(-257, 229, 128, 128);
        insideBtn_1.scaleX = 2.005485985149811;
        insideBtn_1.scaleY = 0.3970985433356721;
        insideBtn_1.angle = -1;
        ...
        // insideBtn_2
        const insideBtn_2 = scene.add.rectangle(-261, 288, 128, 128);
        insideBtn_2.scaleX = 2.6663912616820182;
        insideBtn_2.scaleY = 0.39634073814586324;
        insideBtn_2.angle = -1;
        ...
        // text_1
        const text_1 = scene.add.text(210, -101, "", {});
        text_1.angle = -1;
        text_1.text = "Hover over the\nnames of the winners\nto see their igloos!";
        text_1.setStyle({ "align": "center", "fontFamily": "Burbank Small", "fontSize": "40px", "fontStyle": "bold" });
        _page3.add(text_1);

        // winnerImg
        const winnerImg = scene.add.image(412, -24, "issue19-scorn");
        winnerImg.scaleX = 0.6;
        winnerImg.scaleY = 0.6;
        winnerImg.angle = -1;
        winnerImg.visible = false;
        _page3.add(winnerImg);

        // issue19_pictureframe
        const issue19_pictureframe = scene.add.image(413, -24, "nineteenth-edition", "issue19-pictureframe");
        issue19_pictureframe.angle = -1;
        _page3.add(issue19_pictureframe);

        // winnerTitle
        const winnerTitle = scene.add.text(420, 151, "", {});
        winnerTitle.angle = -1;
        winnerTitle.setOrigin(0.5, 0.5);
        winnerTitle.visible = false;
        winnerTitle.text = "Name";
        winnerTitle.setStyle({ "align": "center", "color": "#000", "fontFamily": "Burbank Small", "fontSize": "40px", "fontStyle": "bold" });
        _page3.add(winnerTitle);
        ...
        // page2
        const page2 = scene.add.image(30, 99, "nineteenth-edition", "issue19-page0002");
        _page2.add(page2);
        ...
        // adaptedpg1
        const adaptedpg1 = scene.add.image(30, 61, "nineteenth-edition", "issue19-page0001");
        ...
        insideBtnSimpleButton.hoverCallback = () => this.iglooWinnerHover('Scorn');
        insideBtnSimpleButton.hoverOutCallback;

        // insideBtn_1 (components)
        const insideBtn_1SimpleButton = new SimpleButton(insideBtn_1);
        insideBtn_1SimpleButton.hoverCallback = () => this.iglooWinnerHover('Tiggyz');
        insideBtn_1SimpleButton.hoverOutCallback;

        // insideBtn_2 (components)
        const insideBtn_2SimpleButton = new SimpleButton(insideBtn_2);
        insideBtn_2SimpleButton.hoverCallback = () => this.iglooWinnerHover('LuciaSixx');
        insideBtn_2SimpleButton.hoverOutCallback;
    ...
    iglooWinnerHover(name){
        this.winnerImg.visible = true
        this.winnerTitle.visible = true
        this.winnerTitle.text = name
        this.winnerImg.setTexture(`issue19-${name.toLowerCase()}`)
    }
