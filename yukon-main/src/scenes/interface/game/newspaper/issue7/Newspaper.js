...
export const preload = {
    key: 'seventh-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/seventh edition/seventh-edition-pack.json',
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // _page5
        const _page5 = scene.add.container(712, 438);
        _page5.visible = false;
        this.add(_page5);

        // page4
        const page4 = scene.add.image(74, 59, "seventh-edition", "meow0035");
        _page5.add(page4);
        ...
        // puffleAnim
        const puffleAnim = scene.add.sprite(440, 60, "seventh-edition", "puffleanim0001");
        _page5.add(puffleAnim);

        // _page4
        const _page4 = scene.add.container(695, 408);
        _page4.visible = false;
        this.add(_page4);

        // pagenot3
        const pagenot3 = scene.add.image(91, 89, "seventh-edition", "meow0026");
        _page4.add(pagenot3);
        ...
        // page3
        const page3 = scene.add.image(91, 89, "seventh-edition", "meow0019");
        _page3.add(page3);
        ...
        // page2
        const page2 = scene.add.image(91, 90, "seventh-edition", "meow0011");
        _page2.add(page2);
        ...
        // page1
        const page1 = scene.add.image(96, 61, "seventh-edition", "meow0001");
        _page1.add(page1);
        ...
        close_23Button.callback = () => { this.closeNews()};
        ...
        // puffleAnim (components)
        const puffleAnimAnimation = new Animation(puffleAnim);
        puffleAnimAnimation.start = 2;
        puffleAnimAnimation.autoPlay = false;
        const puffleAnimSimpleButton = new SimpleButton(puffleAnim);
        puffleAnimSimpleButton.callback = () => this.togglePuffle();
    ...
    /* START-USER-CODE */
    togglePuffle() {
        this.pufflePlaying = !this.pufflePlaying
        if(this.pufflePlaying) {
            this.puffleAnim.__Animation.play()    
        } else {
            this.puffleAnim.stop()
            this.puffleAnim.setFrame("puffleanim0001")    
        }
    }
