...
export const preload = {
    key: 'issue25-pack',
    url: 'assets/media/interface/game/newspaper/issue25/issue25-pack.json', 
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(97, 59, "issue25", "issue25-pg8");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(97, 59, "issue25", "issue25-pg7");
        _page8.add(adaptedpg5);

        // submit_btn_2
        const submit_btn_2 = scene.add.image(267, 392, "newspaper-common", "submit-btn");
        submit_btn_2.scaleX = 0.55;
        submit_btn_2.scaleY = 0.55;
        _page8.add(submit_btn_2);

        // askaapagetext
        const askaapagetext = scene.add.text(178, 379, "", {});
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(97, 59, "issue25", "issue25-pg6");
        ...
        // page3_and_halff
        const page3_and_halff = scene.add.image(97, 59, "issue25", "issue25-pg5");
        ...
        // page3_and_half
        const page3_and_half = scene.add.image(97, 59, "issue25", "issue25-pg4");
        ...
        // page3
        const page3 = scene.add.image(97, 59, "issue25", "issue25-pg3");
        _page3.add(page3);
        ...
        // issue25_pg2
        const issue25_pg2 = scene.add.image(97, 59, "issue25", "issue25-pg2");
        _page2.add(issue25_pg2);
        ...
        // issue25_pg1
        const issue25_pg1 = scene.add.image(97, 30, "issue25", "issue25-pg1");
        _page1.add(issue25_pg1);
