...
export const preload = {
    key: 'sixteenth-edition-pack.json',
    url: 'assets/media/interface/game/newspaper/sixteenth edition/sixteenth-edition-pack.json',
...
export default class Newspaper extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        // page5
        const page5 = scene.add.image(111, 107, "newspaper-buttons-v2", "pageAA");
        _page7.add(page5);

        // left_122
        const left_122 = scene.add.image(-566, 369, "newspaper-buttons-v2", "left");
        left_122.angle = -1;
        _page7.add(left_122);

        // close_232
        const close_232 = scene.add.image(723, -250, "newspaper-buttons-v2", "close");
        close_232.angle = -1;
        _page7.add(close_232);

        // main_122
        const main_122 = scene.add.image(-565, -207, "newspaper-buttons-v2", "main");
        main_122.angle = -1;
        _page7.add(main_122);

        // submit_question
        const submit_question = scene.add.image(426, 188, "newspaper-buttons-v2", "submit");
        ...
        // adaptedpg6
        const adaptedpg6 = scene.add.image(107, 107, "sixteenth-edition", "sixteen_page0006");
        ...
        // adaptedpg5
        const adaptedpg5 = scene.add.image(107, 107, "sixteenth-edition", "sixteen_page0005");
        ...
        // adaptedpg2
        const adaptedpg2 = scene.add.image(107, 107, "sixteenth-edition", "sixteen_page0004");
        ...
        // page3
        const page3 = scene.add.image(107, 107, "sixteenth-edition", "sixteen_page0003");
        _page3.add(page3);
        ...
        // page2 
        const page2_ = scene.add.image(107, 107, "sixteenth-edition", "sixteen_page0002");
        _page2.add(page2_);

        // interview0001
        const interview0001 = scene.add.image(437, 58, "sixteenth-edition", "interview0001");
        interview0001.angle = -1;
        _page2.add(interview0001);
        ...
        // adaptedpg1
        const adaptedpg1 = scene.add.image(109, 70, "sixteenth-edition", "sixteen_page0001");
        ...
        // interview0001 (components)
        const interview0001SimpleButton = new SimpleButton(interview0001);
        interview0001SimpleButton.callback = () => this.onInterview();
        ...
        this.interview0001 = interview0001;
        this.coins = coins;
    ...
    onInterview() {
        this.interviewSlide++
        if(this.interviewSlide > 9) this.interviewSlide = 1

        this.interview0001.setFrame(`interview${this.interviewSlide.toString().padStart(4, "0")}`)
    }
