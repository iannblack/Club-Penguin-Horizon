...
export default class MailbookUserList extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // list
        const list = scene.add.image(0, 0, "mail-book-buddy", "list/list");
        list.setOrigin(0.5011990407673861, 0.5007072135785007);
        this.add(list);

        // scroll
        const scroll = scene.add.image(165, 0, "mail-book-buddy", "list/scroll");
        this.add(scroll);
    ...
    get buddies() {
        ...
        }).filter(obj => !this.world.isMascot(obj.id))
    }
