...
export default class ActionsMenu extends FloatingMenu {
    ...
    constructor(scene, x, y) {
        ...
        // wave_icon_1
        const wave_icon_1 = scene.add.image(-42, -238, "main", "wave");
        wave_icon_1.setOrigin(0, 0);
        this.add(wave_icon_1);

        // sit_icon_1
        const sit_icon_1 = scene.add.image(-36, -101, "main", "sit");
        sit_icon_1.setOrigin(0, 0);
        this.add(sit_icon_1);

        // dance_icon_1
        const dance_icon_1 = scene.add.image(-33, -375, "main", "dance");
        dance_icon_1.setOrigin(0, 0);
        this.add(dance_icon_1);
