...
export const preload = {
    ...
    loadString: ['loading', 'Coffee Tutorial']
}

/* START OF COMPILED CODE */

export default class CoffeeTutorial extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        text_1.text = "Welcome to the Coffee Shop!\n\nI'll be showing you how to order a cup\nof Coffee or become a barista yourself!\n";
        ...
        text_8.text = "To order a cup of coffee, you need to send\nthe         emote and any Penguin wearing\na Coffee Apron can serve you.";
        ...
        // emotes_1
        const emotes_1 = scene.add.image(1, 0, "main", "emotes/13");
        ...
        text_6.text = "You can also get a job at the Coffee Shop and earn     Coins and      Stamps.\n\nTry putting your Coffee Apron on!";
        ...
        text_9.text = "If you don't already have a Coffee Apron,\nyou can purchase one by reading the\nNewspaper!";
        ...
        // news_button
        const news_button = scene.add.image(840, 270, "main", "news-button");
        news_button.scaleX = 0.7;
        news_button.scaleY = 0.7;
        pagen_4.add(news_button);

        // news_new
        const news_new = scene.add.image(870, 281, "main", "news-new");
        news_new.scaleX = 0.8;
        news_new.scaleY = 0.8;
        ...
        // emotes_13
        const emotes_13 = scene.add.image(1, 8, "main", "emotes/13");
        emote.add(emotes_13);
        ...
        // cooldown_timer
        const cooldown_timer = scene.add.sprite(321, 222, "coffee_solo_jobs", "cooldown_timer_0001");
    ...
    checkTutorialStage() {
        if (this.world.room.hasApron) {
            this.startStage2()
        } else if (this.world.room.collectCoffee) {
            this.startStage4()
        } else if (this.world.room.deliveredCoffee) {
            this.startStage5()
        } else {
            this.startTutorial();
        }
    ...
    startStage4() {
        ...
        this.world.room.deliverCoffee = true;
    }
    ...
    onEndStage2() {
        ...
        setTimeout(() => {
            ...
            this.world.room.shop_coffee_solo.visible = true
            this.world.room.coffee_bubble.visible = true;
            setTimeout(() => {
                this.world.room.coffee_bubble.visible = false;
                this.startStage3();
            }, 1500);
        }, 1000);
    }
    ...
    onEndStage3() {
        this.soundManager.playSfx('next');
        this.world.room.collectCoffee = true;
        this.peng_right.visible = false
        this.page4.visible = false
        this.close()       
    }
    ...
    finish() {
        this.world.client.setInteractionAsSeen("coffee_tutorial")
        this.world.room.triggerRoom(110)
