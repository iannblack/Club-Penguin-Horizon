...
export default class IglooMap extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // igloo_bg
        const igloo_bg = scene.add.image(-11, -44, "map", "bg");
        this.add(igloo_bg);

        // igloo_igloo_27
        const igloo_igloo_27 = new IglooButton(scene, -336, -50, "map", "igloo");
        ...
        // igloo_igloo_22
        const igloo_igloo_22 = new IglooButton(scene, -277, -30, "map", "igloo");
        ...
        // igloo_igloo_21
        const igloo_igloo_21 = new IglooButton(scene, -216, -10, "map", "igloo");
        ...
        // igloo_igloo_9
        const igloo_igloo_9 = new IglooButton(scene, -156, 9, "map", "igloo");
        ...
        // igloo_igloo_5
        const igloo_igloo_5 = new IglooButton(scene, -107, 61, "map", "igloo");
        ...
        // igloo_igloo_16
        const igloo_igloo_16 = new IglooButton(scene, -224, 88, "map", "igloo");
        ...
        // igloo_igloo_20
        const igloo_igloo_20 = new IglooButton(scene, -150, 119, "map", "igloo");
        ...
        // igloo_igloo_19
        const igloo_igloo_19 = new IglooButton(scene, -89, 140, "map", "igloo");
        ...
        // igloo_igloo_29
        const igloo_igloo_29 = new IglooButton(scene, -439, -16, "map", "igloo");
        ...
        // igloo_igloo_28
        const igloo_igloo_28 = new IglooButton(scene, -382, 36, "map", "igloo");
        ...
        // igloo_igloo_18
        const igloo_igloo_18 = new IglooButton(scene, -323, 57, "map", "igloo");
        ...
        // igloo_igloo_17
        const igloo_igloo_17 = new IglooButton(scene, -286, 116, "map", "igloo");
        ...
        // igloo_igloo_10
        const igloo_igloo_10 = new IglooButton(scene, 108, 67, "map", "igloo");
        ...
        // igloo_igloo_6
        const igloo_igloo_6 = new IglooButton(scene, 81, 117, "map", "igloo");
        ...
        // igloo_igloo_8
        const igloo_igloo_8 = new IglooButton(scene, 188, 101, "map", "igloo");
        ...
        // igloo_igloo_13
        const igloo_igloo_13 = new IglooButton(scene, -121, -144, "map", "igloo");
        ...
        // igloo_igloo_12
        const igloo_igloo_12 = new IglooButton(scene, -76, -108, "map", "igloo");
        ...
        // igloo_igloo_25
        const igloo_igloo_25 = new IglooButton(scene, -35, -67, "map", "igloo");
        ...
        // igloo_igloo_2
        const igloo_igloo_2 = new IglooButton(scene, -46, -7, "map", "igloo");
        ...
        // igloo_igloo_14
        const igloo_igloo_14 = new IglooButton(scene, 135, -49, "map", "igloo");
        ...
        // igloo_igloo_3
        const igloo_igloo_3 = new IglooButton(scene, 95, -28, "map", "igloo");
        ...
        // igloo_igloo_1
        const igloo_igloo_1 = new IglooButton(scene, 44, 6, "map", "igloo");
        ...
        // igloo_igloo_0
        const igloo_igloo_0 = new IglooButton(scene, -5, 40, "map", "igloo");
        ...
        // igloo_igloo_15
        const igloo_igloo_15 = new IglooButton(scene, 191, -14, "map", "igloo");
        ...
        // igloo_igloo_23
        const igloo_igloo_23 = new IglooButton(scene, -136, -73, "map", "igloo");
        ...
        // igloo_igloo_24
        const igloo_igloo_24 = new IglooButton(scene, -189, -75, "map", "igloo");
        ...
        // igloo_igloo_26
        const igloo_igloo_26 = new IglooButton(scene, -31, -180, "map", "igloo");
        ...
        // igloo_igloo_7
        const igloo_igloo_7 = new IglooButton(scene, 10, -156, "map", "igloo");
        ...
        // igloo_igloo_11
        const igloo_igloo_11 = new IglooButton(scene, 71, -140, "map", "igloo");
        ...
        // igloo_igloo_4
        const igloo_igloo_4 = new IglooButton(scene, 37, -107, "map", "igloo");
        ...
        // igloo_note
        const igloo_note = scene.add.image(-485, -268, "map", "note");
        this.add(igloo_note);
        ...
        // spinner
        const spinner = scene.add.image(-19, -55, "map", "spinner");
        ...
        // igloo_card
        const igloo_card = scene.add.image(197, 318, "map", "card");
        panel.add(igloo_card);

        // igloo_tape
        const igloo_tape = scene.add.image(5, 0, "map", "tape");
        igloo_tape.setOrigin(0.5017421602787456, 0.5);
        panel.add(igloo_tape);

        // igloo_item_large
        const igloo_item_large = scene.add.image(183, 72, "map", "item_large");
        panel.add(igloo_item_large);

        // igloo_icon_player
        const igloo_icon_player = scene.add.image(18, 72, "map", "icon_player");
        ...
        igloo_item_largeButton.spriteName = "item_large";
    ...
    setIgloos(igloos) {
        ...
        this.igloos = igloos.sort((a, b) => {
            ...
            // return `P${a.id}`.localeCompare(`P${b.id}`.toLowerCase())
        })
