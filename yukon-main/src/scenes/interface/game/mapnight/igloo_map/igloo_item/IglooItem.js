...
export default class IglooItem extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // buddy_item
        const buddy_item = scene.add.image(0, 0, "map", "item_small");
        this.add(buddy_item);

        // icon
        const icon = scene.add.image(-137, 0, "map", "icon_none");
        this.add(icon);
        ...
        buddy_itemButton.spriteName = "item_small";
    ...
    setItem(igloo) {
        ...
        let texture = `icon_${relationship}`
