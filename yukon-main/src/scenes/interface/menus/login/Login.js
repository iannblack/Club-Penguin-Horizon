...
export default class Login extends BaseScene {
    ...
    create() {
        ...
        this.usernameInput = new TextInput(this, 815, 200, 'text', style, () => this.onLoginSubmit(), 13, false)
        this.passwordInput = new TextInput(this, 815, 259, 'password', passwordStyle, () => this.onLoginSubmit(), 128, false, undefined, /(?!.*)/gi)
    ...
    onLoginSubmit() {
        ...
        this.network.connectLogin(this.checks.username.checked, this.checks.password.checked, () => {
            this.network.send('login', { username: username, password: password, secret: secret })
        })
    }
