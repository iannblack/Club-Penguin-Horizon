...
export default class Server extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // name
        const name = scene.add.text(-125, -27, "", {});
        ...
        // full
        const full = scene.add.text(70, -50, "", {});
        full.visible = false;
        full.text = "QUEUE";
        full.setStyle({ "fontFamily": "CCFaceFront", "fontSize": "76px", "fontStyle": "bold italic", "stroke": "#003366", "strokeThickness":15});
        this.add(full);
