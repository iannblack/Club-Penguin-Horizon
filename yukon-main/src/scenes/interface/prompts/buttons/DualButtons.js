...
export default class DualButtons extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        /** @type {() => void} */
        this.yesCallback = () => this.parentContainer.callback();
        /** @type {() => void} */
        this.noCallback = () => this.parentContainer.noCallback();
        ...
        no_buttonButton.activeFrame = true;
        ...
        yes_buttonButton.activeFrame = true;
