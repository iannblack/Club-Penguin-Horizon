...
export default class IcePond extends RoomScene {
    ...
    _preload() {
        ...
        this.load.pack("fair-icepond-pack", "assets/media/rooms/_fair/icepond/fair-icepond-pack.json");
    ...
    _create() {
        ...
        // logsss
        this.add.image(366, 424, "fair-icepond", "logsss");

        // logSwirls
        this.add.image(371, 429, "fair-icepond", "logSwirls");

        // houseee
        this.add.image(140, 419, "fair-icepond", "houseee");

        // door
        const door = this.add.image(137, 568, "icepond", "door");

        // snowowww
        this.add.image(314, 644, "fair-icepond", "snowowww");
        ...
        // bigtree_1
        const bigtree_1 = this.add.image(1148, 325, "icepond", "bigtreeside");
        ...
        // backdropposter
        const backdropposter = this.add.image(1375.230224609375, 466.9755003119926, "fair-icepond", "backdropposter");
        backdropposter.setOrigin(0.4702172959386561, 3.0143252734507353);

        // posters
        const posters = this.add.image(1370.6151123046875, 477.0401114543604, "fair-icepond", "posters");
        posters.setOrigin(0.4935586244704535, 1.2953417295418224);

        // icepond_fair
        const icepond_fair = this.add.image(760, 480, "icepond fair");
        icepond_fair.visible = false;
        icepond_fair.alpha = 0.5;
        icepond_fair.alphaTopLeft = 0.5;
        icepond_fair.alphaTopRight = 0.5;
        icepond_fair.alphaBottomLeft = 0.5;
        icepond_fair.alphaBottomRight = 0.5;

        // lists
        const sort = [bigtree, equipment, treefront, bigtree_1, fishingrod, fishbox, holeside, fluffyjump0001, fluffyjump0006, fishinfishbox, catalog0001, backdropposter, posters];
