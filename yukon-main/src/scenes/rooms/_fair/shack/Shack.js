...
export default class Shack extends RoomScene {
    ...
    _preload() {
        ...
        this.load.pack("shack-pack", "assets/media/rooms/_fair/shack/shack-pack.json");
    }
    ...
    _create() {
        ...
        // sign
        const sign = this.add.image(368, 177, "fair-town", "sign");
        sign.scaleX = 0.6954739502310928;
        sign.scaleY = 0.6954739502310928;

        // circus_sign
        const circus_sign = this.add.image(107.2360305786133, 686.6179963708654, "fair-town", "circus_sign");
        circus_sign.angle = 8;
        circus_sign.setOrigin(0.5773282873200747, 0.5165272187969042);

        // balloon
        const balloon = this.add.image(827, 487, "fair-town", "balloon");
        balloon.angle = 14.999999999999998;

        // balloon_bottom
        const balloon_bottom = this.add.image(346, 507, "fair-town", "balloon_bottom");
        balloon_bottom.scaleX = 0.6264683151288208;
        balloon_bottom.scaleY = 0.6264683151288208;

        // balloon_2
        const balloon_2 = this.add.image(617.4606568157138, 579.2819407683091, "fair-town", "balloon");
        balloon_2.angle = -20;
        balloon_2.setOrigin(0.5768121738364738, 0.5383841317993383);
        balloon_2.flipX = true;

        // lists
        const sort = [house, pipe_1, pipe_2, trees_2, bear, bag, barrel_2, shovel, fence, cart_1, cart_2, flowers, trees_1, plant_1_3, plant_1_2, plant_1_1, plant_1_0, plant0_3, plant0_2, plant0_1, plant0_0, plant_2_3, plant_2_2, plant_2_1, plant_2_0, plant_3_0, plant_3_3, plant_3_2, plant_3_1, plant_4_0, plant_4_3, plant_4_2, plant_4_1, spray1_end, spray1_operating, spray1_start, spray2_end, spray2_operating, plantbad_0_0, plantbad_4_3, plantbad_4_2, plantbad_4_1, plantbad_4_0, plantbad_3_3, plantbad_3_2, plantbad_3_1, plantbad_3_0, plantbad_2_3, plantbad_2_2, plantbad_2_1, plantbad_2_0, plantbad_1_3, plantbad_1_2, plantbad_1_1, plantbad_1_0, plantbad_0_3, plantbad_0_2, plantbad_0_1, spray2_start, flowercart, flowers_1, circus_sign, balloon, balloon_bottom, balloon_2];
