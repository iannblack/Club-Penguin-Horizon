...
import { Animation, HoverAnimation, Button, MoveTo, SimpleButton, Zone, ShowHint, ZoneTrigger } from '@components/components'
...
export default class Hideout extends RoomScene {
    ...
    _preload() {
        ...
        this.load.pack("fair-hideout-pack", "assets/media/rooms/_fair/hideout/fair-hideout-pack.json");
    }
    ...
    _create() {
        ...
        // balloon_bottom
        const balloon_bottom = this.add.image(756, 650.2576544523057, "fair-town", "balloon_bottom");
        balloon_bottom.setOrigin(0.5, -0.01793876438155439);

        // balloon
        const balloon = this.add.image(750, 613, "fair-town", "balloon");

        // gift_arrow0001
        const gift_arrow0001 = this.add.sprite(318.4674050606675, 577.4213870942895, "fair-town", "gift_arrow0001");
        gift_arrow0001.setOrigin(0.8265051930854806, 3.1060396109874224);

        // lists
        const sort = [store_mc, trees1, trees2, tablestwo, tablesone, sign, stairs, overlay, book, cards_button, balloon_bottom, balloon, gift_arrow0001];
        ...
        // gift_arrow0001 (components)
        const gift_arrow0001Animation = new Animation(gift_arrow0001);
        gift_arrow0001Animation.key = "gift_arrow";
        gift_arrow0001Animation.end = 25;
