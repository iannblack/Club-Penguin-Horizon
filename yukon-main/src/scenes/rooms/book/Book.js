...
export default class Book extends RoomScene {
    ...
    constructor() {
        ...
        this.roomTriggers = {
            ...
            'library': () => this.interface.loadWidget('Library'),
    ...
    _create() {
        ...
        // interfaceIcons
        const interfaceIcons = this.add.image(1435.0000261607795, 872.000002672045, "book-btn", "bookbtn");
        ...
        const booksMoveTo = new MoveTo(books);
        booksMoveTo.x = 360;
        booksMoveTo.y = 470;
        ...
        posterButton.callback = () => this.interface.loadWidget('HowtoPlay');
        posterButton.pixelPerfect = true;

        // interfaceIcons (components)
        const interfaceIconsButton = new Button(interfaceIcons);
        interfaceIconsButton.spriteName = "bookbtn";
        interfaceIconsButton.callback = () => this.onLibrary();
    ...
    /* START-USER-CODE */
    onLibrary() {
        this.interface.loadWidget('Library')    
    }
    /* END-USER-CODE */
}
