...
export default class HQPhase2 extends RoomScene {
    ...
    constructor() {
        ...
        this.music = 7
        this.physicsKey = 'hqphase2-physics'
    ...
    _preload() {
        ...
        this.load.pack("hqphase2-pack", "assets/media/rooms/_mission11/hqphase2/hqphase2-pack.json");
    ...
    _create() {
        ...
        // dojobg
        const dojobg = this.add.image(770, 481, "hq-room", "background");
        dojobg.visible = false;

        // background
        this.add.image(770, 480, "hqphase2", "background");

        // crack
        this.add.image(140, 122, "hqphase2", "crack");
        ...
        // door_1
        const door_1 = this.add.sprite(183, 447, "hq-room", "truedoor0001");
        ...
        cabinet_nonpsa.visible = false;

        // shadows
        this.add.image(837, 741, "hqphase2", "shadows");

        // missionCommand
        this.add.image(757, 406, "hqphase2", "missionCommand");

        // stackOfTVs
        const stackOfTVs = this.add.image(1150, 558, "hqphase2", "stackOfTVs");

        // morePopcorn
        this.add.image(1356, 630, "hqphase2", "morePopcorn");

        // closet
        this.add.image(1487, 557, "hqphase2", "closet");

        // embeddedTV
        const embeddedTV = this.add.image(903, 490.5245285815196, "hqphase2", "embeddedTV");
        embeddedTV.setOrigin(0.5, 0.5342187240924231);

        // crateStuff
        const crateStuff = this.add.image(1379, 747.6415023992773, "hqphase2", "crateStuff");
        crateStuff.setOrigin(0.5, 0.5665717071670843);

        // bottomPopcorn
        this.add.image(769, 853, "hqphase2", "bottomPopcorn");

        // randomMetalThing
        const randomMetalThing = this.add.image(1203, 677.864170881308, "hqphase2", "randomMetalThing");
        randomMetalThing.setOrigin(0.5, 0.3817513350102191);

        // books
        const books = this.add.image(1282, 709, "hqphase2", "books");

        // trashCan
        const trashCan = this.add.image(183, 689, "hqphase2", "trashCan");

        // agent_danceclub
        const agent_danceclub = this.add.sprite(563, 250, "hq-room", "agent_danceclub0001");
        agent_danceclub.visible = false;
        ...
        // loneTV
        this.add.image(552, 152, "hqphase2", "loneTV");

        // wiresLeft
        this.add.image(202, 137, "hqphase2", "wiresLeft");

        // lights
        this.add.image(780, 216, "hqphase2", "lights");

        // hQPhase2Preview
        const hQPhase2Preview = this.add.image(768, 481, "HQPhase2Preview");
        hQPhase2Preview.visible = false;
        hQPhase2Preview.alpha = 0.5;
        hQPhase2Preview.alphaTopLeft = 0.5;
        hQPhase2Preview.alphaTopRight = 0.5;
        hQPhase2Preview.alphaBottomLeft = 0.5;
        hQPhase2Preview.alphaBottomRight = 0.5;
        ...
        // lists
        const sort = [chairtwo, chairone, trashCan, stackOfTVs, randomMetalThing, crateStuff, embeddedTV, books];
