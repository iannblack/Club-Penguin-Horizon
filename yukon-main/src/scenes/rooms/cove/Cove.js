...
export default class Cove extends RoomScene {
    ...
    constructor() {
        ...
        this.roomTriggers =  {
            'dark_cave': () => this.triggerRoom(8100, 140, 500),
    ...
    _create() {
        ...
        // bg
        const bg = this.add.image(-78, -77, "cove", "bg");
        bg.setOrigin(0, 0);
        ...
        log_1.setOrigin(0, 0);
        log_1.tintTopLeft = 16777215;
        log_1.tintTopRight = 16777215;
        log_1.tintBottomLeft = 16777215;
        log_1.tintBottomRight = 16777215;
        ...
        // interfaceIcons
        const interfaceIcons = this.add.image(1434, 891, "cove-catalogbtn", "catalogbtn");

        // catalogirl
        const catalogirl = this.add.sprite(1062, 572, "cove-catalogbtn", "catalogirl0001");
        catalogirl.setOrigin(0.9210526315789473, 4.035714285714286);

        // cave_glow0001
        const cave_glow0001 = this.add.sprite(1123, 223, "cove", "cave_glow0001");

        // lists
        const sort = [water_water_15, water_water_1, water_water_2, water_water_3, water_water_4, water_water_5, water_water_6, water_water_7, water_water_8, water_water_9, water_water_10, water_water_11, water_water_12, water_water_13, water_water_14, hut_wall, boards, rock_1, fire, chair_arm, binocularbtn, silver_board, rock_3, rock_2, rock_4, fg, catalogirl];
        ...
        // cave_glow0001 (components)
        const cave_glow0001Animation = new Animation(cave_glow0001);
        cave_glow0001Animation.key = "cave_glow";
        cave_glow0001Animation.end = 50;
        cave_glow0001Animation.autoPlay = false;

        this.interfaceIcons = interfaceIcons;
        this.catalogirl = catalogirl;
        this.cave_glow0001 = cave_glow0001;
        this.sort = sort;
    ...
    create() {
        super.create();
        this.cave_glow0001.__Animation.play();
    }
