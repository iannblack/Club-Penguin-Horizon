...
export default class ClientSledPlayer extends SledPlayer {
    ...
    constructor(scene, x, y) {
        ...
        scene.input.keyboard.on('keydown-W', this.onMoveUpKey, this)
        scene.input.keyboard.on('keydown-D', this.onMoveUpKey, this)
        scene.input.keyboard.on('keydown-S', this.onMoveDownKey, this)
        scene.input.keyboard.on('keydown-A', this.onMoveDownKey, this)
    }
