...
export default class SledPlayer extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // player_winterracingsled_1_body
        const player_winterracingsled_1_body = scene.add.image(0, 0, "sledcustoms", "player/winterracingsled/1/body");
        player_winterracingsled_1_body.visible = false;
        character.add(player_winterracingsled_1_body);

        // player_winterracingsled_1_penguin
        const player_winterracingsled_1_penguin = scene.add.image(0, 0, "sledcustoms", "player/winterracingsled/1/penguin");
        player_winterracingsled_1_penguin.visible = false;
        character.add(player_winterracingsled_1_penguin);

        // player_livingtoboggan_1_body
        const player_livingtoboggan_1_body = scene.add.image(0, 0, "sledcustoms", "player/livingtoboggan/1/body");
        player_livingtoboggan_1_body.visible = false;
        character.add(player_livingtoboggan_1_body);

        // player_livingtoboggan_1_penguin
        const player_livingtoboggan_1_penguin = scene.add.image(0, 0, "sledcustoms", "player/livingtoboggan/1/penguin");
        player_livingtoboggan_1_penguin.visible = false;
        character.add(player_livingtoboggan_1_penguin);
    ...
    get isLivingtoboggan() {
        return this.sledType === 'livingtoboggan'
    }
    get isWinterracingsled() {
        return this.sledType === 'winterracingsled'
    }
    ...
    setSled(hand) {
        switch (hand) {
            ...
            case 5047:
                ...
                break
            case 380120:
                this.sledType = 'livingtoboggan'
                break
            case 380170:
                this.sledType = 'winterracingsled'
                break
            default:
                this.sledType = 'tube'
    ...
    setFrame(frame) {
        ...
        if (this.isLivingtoboggan) {
        this.body.setTexture(`sledcustoms`, `player/${this.sledType}/${frame}/body`)
        this.penguin.setTexture(`sledcustoms`, `player/${this.sledType}/${frame}/penguin`)
        }
        if (this.isWinterracingsled) {
        this.body.setTexture(`sledcustoms`, `player/${this.sledType}/${frame}/body`)
        this.penguin.setTexture(`sledcustoms`, `player/${this.sledType}/${frame}/penguin`)
        }
