...
export default class InventoryLoader extends BaseLoader {
    ...
    constructor(scene, inventory) {
        ...
        this.baseURL =  (process.env.NODE_ENV === 'development' || true) ? '/assets/media/clothing/icon/120/' : CDN_URL + 'assets/media/clothing/icon/120/'
