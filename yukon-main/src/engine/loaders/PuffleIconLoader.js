...
export default class PuffleIconLoader extends BaseLoader {
    ...
    constructor(scene, prompt) {
        ...
        this.baseURL = (process.env.NODE_ENV === "development") ? "/assets/media/puffles/icons/" : CDN_URL + "assets/media/puffles/icons/";
        this.keyPrefix = "puffle/icons/";
    }
    ...
    onFileComplete(key, item) {
        if (!this.prompt.visible || !this.textureExists(key) || item != this.prompt.puffle) {
            return
        }
