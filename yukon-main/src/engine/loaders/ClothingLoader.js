...
export default class ClothingLoader extends BaseLoader {
    ...
    constructor(penguin) {
        ...
        this.baseURL =  (process.env.NODE_ENV === 'development' || true) ? '/assets/media/clothing/sprites/' : CDN_URL + "assets/media/clothing/sprites/"
    ...
    loadItem(item, slot) {
        ...
        this.penguin.loadItemAudio(item)
    }
    ...
    addItem(slot, item) {
        ...
        if(this.penguin.isTransformed) equipped.sprite.visible = false
